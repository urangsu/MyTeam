...
enum CharacterCatalog {
    ...
    static let builtIn: [CharacterDLC] = [
        ...
        makeBuiltIn(id: "chiko", agentID: "agent_5", name: "치코", subtitle: "사용자 여정과 사용성을 살피는 UX 디자이너", portrait: "치코_profile", sprite: "치코", bundledSkillIDs: ["korean.naver-blog-research"]),
