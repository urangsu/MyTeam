...
- txt / md / markdown / csv 파일 입력
- 위험 확장자 차단
- 큰 파일 차단
- PDF / DOCX / XLSX / PPTX 준비 중 안내
- 파일 선택 UX 추가
- 가능하면 drag/drop UX 추가
- File Intake → Universal Document 연결 준비
- 자동 문서 생성은 다음 라운드로 보류
- Gmail / OAuth / Calendar write 미구현 유지
...
- 파일 내용을 Universal Document request sourceText로 연결
- 파일 기반 요약 / 보고서 / 표 / 체크리스트 생성
- artifact 저장 완료 메시지 polish
- 실패 이유 표시
- PDF / DOCX / XLSX / PPTX는 계속 단계적 지원
