...
- [ ] 0. 현재 상태 확인 (merge commit daa2b52)
- [ ] 1. TASK.md 대정리 (현재 라운드: Round 43R-47H-FINAL)
- [ ] 2. Swift 파일 Xcode target 점검 및 pbxproj 중복 제거
- [ ] 3. FirstLaunchStateProvider 실제 연결 (TeamStatusView, DailyBriefingCardView, SettingsView, AgentWindowManager)
