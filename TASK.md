...
- 요약 / 보고서 / 체크리스트 / 표 / 회의록 / 액션아이템 문서 생성
- 자연어 기반 문서 유형 감지
- Markdown artifact 저장
- GoalInterpreter 관측 결과와 충돌 없이 연결
- Router burn-in case 추가
- Google OAuth blocked 상태 유지
...
- 결과 품질 검증 강화
- 완료 메시지 polish
- artifact card와 문서 유형 badge 연결
- 모호한 요청 clarification UX 개선
