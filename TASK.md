...
- Daily Briefing 채팅 응답 섹션형 개선
- DailyBriefingCardView empty / connector 메시지 polish
- ConnectorGuard read capability 상태 기반 helper 추가
- Daily Briefing route guard 보강
- RuntimeDiagnostics 민감정보 미노출 유지
...
#### Round 30C — Daily Briefing Runtime QA + Connector State QA

목표:

- 오늘 브리핑 route runtime 확인
- Calendar 미연결 / 로컬 브리핑 / Gmail 준비 중 상태 확인
- ConnectorGuard blocked / unavailable / requiresApproval QA
- Deferred QA 일부 재확인 가능
