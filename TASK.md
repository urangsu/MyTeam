...
- RoomRuntimeStore 추가
- roomGoalContext / lastFileIntakeResult / activeTask ownership 정리
- AgentWindowManager는 facade로 유지
- in-memory / persistence 기준 명확화
- Daily Briefing / File Intake / Universal Document 회귀 없음
- Deferred Runtime QA Backlog 유지

### Next

#### Round 31C — Workflow Runner Boundary Expansion

목표:

- Universal Document legacy / PlanRunner wrapper 경계 정리
- WorkflowRunner 실행 entrypoint 확대
- WorkflowOrchestrator route/execution 책임 추가 축소
- 새 기능 추가 금지
