...
- Google OAuth config 입력/검증 준비
- Calendar read-only client skeleton
- DailyBriefingService calendar provider 구조 개선
- 실제 OAuth/API 호출은 아직 하지 않음
- 다음 라운드에서 Desktop OAuth + Calendar read-only 실제 연결
